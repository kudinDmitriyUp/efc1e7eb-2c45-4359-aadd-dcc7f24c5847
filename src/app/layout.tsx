...
export const metadata: Metadata = {
  title: "AquaDive Center | Professional Scuba Diving Courses",
  description: "Learn scuba diving with certified PADI instructors. Open Water, Advanced, and Rescue Diver courses for all levels. Book your diving adventure today.",
  keywords: "scuba diving, diving courses, PADI certified, scuba instruction, underwater diving, diving certification",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "AquaDive Center | Professional Scuba Diving Courses",
    description: "Explore the underwater world with certified instructors. Professional scuba diving courses for beginners to advanced divers.",
    type: "website",
    siteName: "AquaDive Center",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/tmp/underwater-coral-reef-diving-1764603110753-4898a9e9.jpg",
        alt: "Underwater diving exploration"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "AquaDive Center | Scuba Diving Courses",
    description: "Professional PADI-certified diving instruction for all levels.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/tmp/underwater-coral-reef-diving-1764603110753-4898a9e9.jpg"]
  }
};
